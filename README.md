...
- **Pipes** - The biggest game in here you have to connect pipes to points:
  ...
  - The points with the lime border represent checkpoints, you first have to connect the pipe to them to them.
  - Connecting a pipe to checkpoint reveals another checkpoint or an end (full red square).
  - You can remove the pipes by **right clicking** on them (You can rebuild your pipes, and the order of checkpoints doesn't matter).
  - You win by connecting the the start square to the end square.
- **Plants** - In here you have:
  -  to cover as much of the soil as you can with seeds in 5 turns.
  -  the gray squares are rocks you can't plant on them.
  -  when you click a button, a plane will plant seeds in a straight line from your button.
  -  In here you win by beating your own score :).
